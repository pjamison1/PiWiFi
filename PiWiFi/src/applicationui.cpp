 ...
 * This line added to cloned source
 * This line added via GitHub Edit facility online.
 */
    ...
    , _scanning(false)
{
    ...
    _qml->setContextProperty("settings", new AppSettings());
...
void ApplicationUI::onInvoked(const bb::system::InvokeRequest &request)
{
    ...
    qDebug() << "PIJ PIJ PIJ  Received invoke=" << request.action();
...
void ApplicationUI::onSystemLanguageChanged()
{
    ...
    QString file_name = QString("PiWiFi_%1").arg(localeString);
