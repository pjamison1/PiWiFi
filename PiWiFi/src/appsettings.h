...
class AppSettings: public QObject
{
    ...
    /**
             * The uuid property stores the setting.
             */
...
private:
    ...
    static const QString mDefaultMsg;
    static const QString mDefaultUuid;
    ...
    static const QString WIFI_KEY;
    static const QString WIFI_UUID;
